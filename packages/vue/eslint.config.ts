...
export default defineConfig(
  {
    ...
    ignores: [
      ...
      // Generated by the registry build. The formatter pads markdown table
      // cells, which the generator does not, so linting it would make
      // `registry:check` and `eslint --fix` undo each other on every run.
      'docs/component-graph.md',
    ],
  },
