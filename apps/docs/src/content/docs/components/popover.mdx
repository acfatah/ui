---
title: Popover
description: Displays rich content in a floating layer, anchored to the element that opened it.
---

import PopoverDemo from "packages.vue/components/ui/popover/examples/PopoverDemo.vue";
import PopoverDefault from "packages.vue/components/ui/popover/examples/PopoverDefault.vue";
import PopoverControlled from "packages.vue/components/ui/popover/examples/PopoverControlled.vue";
import PopoverPlacement from "packages.vue/components/ui/popover/examples/PopoverPlacement.vue";
import PopoverAnchor from "packages.vue/components/ui/popover/examples/PopoverAnchor.vue";
import PopoverCloseBehavior from "packages.vue/components/ui/popover/examples/PopoverCloseBehavior.vue";
import PopoverModal from "packages.vue/components/ui/popover/examples/PopoverModal.vue";
...
```bash
bunx --bun shadcn@latest add acfatah/ui/vue/popover
```
...
in `styles.ts`; see [Animation](/theming/animation) to change it.
...
<Demo>
  <PopoverDefault client:only="vue" />
</Demo>
...
<Demo>
  <PopoverControlled client:only="vue" />
</Demo>
...
<Demo>
  <PopoverPlacement client:only="vue" />
</Demo>
...
<Demo>
  <PopoverCloseBehavior client:only="vue" />
</Demo>
