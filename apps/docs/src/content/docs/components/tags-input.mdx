---
title: Tags Input
description: A text input that turns what is typed into a list of removable, editable tags.
---

import TagsInputDemo from "packages.vue/components/ui/tags-input/examples/TagsInputDemo.vue";
import TagsInputDefault from "packages.vue/components/ui/tags-input/examples/TagsInputDefault.vue";
import TagsInputDisabled from "packages.vue/components/ui/tags-input/examples/TagsInputDisabled.vue";
import TagsInputControlled from "packages.vue/components/ui/tags-input/examples/TagsInputControlled.vue";
import TagsInputInvalid from "packages.vue/components/ui/tags-input/examples/TagsInputInvalid.vue";
import TagsInputReadOnly from "packages.vue/components/ui/tags-input/examples/TagsInputReadOnly.vue";
import TagsInputBlurBehavior from "packages.vue/components/ui/tags-input/examples/TagsInputBlurBehavior.vue";
import TagsInputCustomItem from "packages.vue/components/ui/tags-input/examples/TagsInputCustomItem.vue";
import TagsInputEditable from "packages.vue/components/ui/tags-input/examples/TagsInputEditable.vue";
import TagsInputMany from "packages.vue/components/ui/tags-input/examples/TagsInputMany.vue";
import TagsInputMax from "packages.vue/components/ui/tags-input/examples/TagsInputMax.vue";
import TagsInputPaste from "packages.vue/components/ui/tags-input/examples/TagsInputPaste.vue";
import TagsInputValidate from "packages.vue/components/ui/tags-input/examples/TagsInputValidate.vue";
...
```bash
bunx --bun shadcn@latest add acfatah/ui/vue/tags-input
```
...
<Demo>
  <TagsInputControlled client:load />
</Demo>
...
<Demo>
  <TagsInputBlurBehavior client:load />
</Demo>
...
<Demo>
  <TagsInputCustomItem client:load />
</Demo>
