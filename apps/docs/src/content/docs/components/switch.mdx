...
import SwitchDemo from "packages.vue/components/ui/switch/examples/SwitchDemo.vue";
import SwitchDefault from "packages.vue/components/ui/switch/examples/SwitchDefault.vue";
import SwitchChecked from "packages.vue/components/ui/switch/examples/SwitchChecked.vue";
import SwitchDisabled from "packages.vue/components/ui/switch/examples/SwitchDisabled.vue";
import SwitchControlled from "packages.vue/components/ui/switch/examples/SwitchControlled.vue";
import SwitchInvalid from "packages.vue/components/ui/switch/examples/SwitchInvalid.vue";
import SwitchReadOnly from "packages.vue/components/ui/switch/examples/SwitchReadOnly.vue";
import SwitchLoading from "packages.vue/components/ui/switch/examples/SwitchLoading.vue";
...
```bash
bunx --bun shadcn@latest add acfatah/ui/vue/switch
```
