...
import ButtonDestructive from "packages.vue/components/ui/button/examples/ButtonDestructive.vue";
...
`bg-destructive` with destructive focus-ring tones; for irreversible
actions.
