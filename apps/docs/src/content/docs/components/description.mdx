---
title: Description
description: Supporting text that gives a control, title or heading more context.
---

import DescriptionDefault from "packages.vue/components/ui/description/examples/DescriptionDefault.vue";
import DescriptionWithLink from "packages.vue/components/ui/description/examples/DescriptionWithLink.vue";
...
<Demo>
  <DescriptionDefault client:load />
</Demo>
...
```bash
bunx --bun shadcn@latest add acfatah/ui/vue/description
```
...
<Demo>
  <DescriptionWithLink client:load />
</Demo>
