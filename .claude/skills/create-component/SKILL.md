...
`switch` for T2, `popover` for T3, `tags-input` for T4. A component
wrapping a multi-part Ark machine follows `references/compound.md`,
which explains what the T2 reference does and what the T3 reference
adds.
